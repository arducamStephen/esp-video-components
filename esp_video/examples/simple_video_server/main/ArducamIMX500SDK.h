...
#define MAX_POST_ESTIMATION_ITEM_NUM    10
...
typedef struct {
    BBox bboxs[MAX_DETECT_ITEM_NUM];
    uint16_t valid_num;
} DetectionResult;
...
typedef struct {
    PoseKeyPoints kps_group[MAX_POST_ESTIMATION_ITEM_NUM];
    BBox bboxs[MAX_POST_ESTIMATION_ITEM_NUM];
    uint16_t valid_num;
